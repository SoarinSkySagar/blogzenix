          ...
          {posts.map((post) => (
            <div key={post.title} className="flex flex-col rounded-2xl shadow-lg overflow-hidden">
              <div className="flex-shrink-0">
                <Image className="h-48 w-full object-cover" src={post.imageUrl} alt="" height={1000} width={1000} />
              </div>
                ...
                <div className="mt-6 flex items-center">
                  <div className="flex-shrink-0">
                    <a href={post.author.href}>
                      ...
                      <Image className="h-10 w-10 rounded-full" src={post.author.imageUrl} alt="" height={100} width={100} />
                    </a>
                  </div>
                  <div className="ml-3">
